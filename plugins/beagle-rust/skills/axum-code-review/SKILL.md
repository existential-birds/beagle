...
Complete **Gates (before reporting findings)**; gate 3 is the single verification pass over the finding list, using `beagle-core:review-verification-protocol` plus the [Rust delta](../rust-verification-protocol/SKILL.md).
